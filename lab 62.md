...
## Proof of Concept Request
  ```Screenshot 1``` — The Reports listing page showing the raw script payload stored as-is in row #7 under "Created By" as `<script>alert(1)</script>`, meaning the app saved it exactly as typed with no filtering at all.
   ...
   <img width="1920" height="1080" alt="Screenshot From 2026-05-24 15-49-22" src="https://github.com/user-attachments/assets/4ae5de70-1f61-402e-b641-0752fecfb918" />
...
<img width="1920" height="1080" alt="Screenshot From 2026-05-24 15-49-29" src="https://github.com/user-attachments/assets/1cacbfa7-1cdc-42b9-8163-e03c6233fedf" />
